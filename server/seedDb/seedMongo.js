...
console.log("STARTING MONGODB Seeding Data Script...");
...
function getBooksFormatted() {
  ...
  for (const book of booksFromCSV.slice(0, NUMBER_OF_BOOKS_TO_ADD)) {
    ...
    console.log(`${booksExample.book_uuid} added. progress: ${count}/${NUMBER_OF_BOOKS_TO_ADD}`)
    count++;
  }
...
async function seedMongo() {
  ...
  console.log("Finished inserting books into MongoDB...");
...
console.log("MONGODB SCRIPT HAS FINISHED.......");
